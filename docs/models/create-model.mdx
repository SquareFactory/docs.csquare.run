...
- A model's information can be edited at anytime: [see how](edit-model).
- [Create an experiment](../experiments/run-experiment) to start using your new model!
...
1. #### [Select the project](../projects/select-project.mdx) you want your model to be a part of.
...
3. #### Fill the form
   ...
   3. Choose one or several [datasets](../datasets/create-dataset) to be mounted in your container.
...
You will now be redirected to your new model's page. Well done!
