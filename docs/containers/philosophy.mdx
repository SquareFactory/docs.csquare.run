...
:::note
In order to use the NVIDIA NGC, you need to [set up your registries accordingly](/docs/containers/registries#nvidia-ngc).
:::

:::danger
Ensure that you allocate for memory than your container image size, otherwise your experiment might fail with an `OUT_OF_MEMORY` error.
:::
