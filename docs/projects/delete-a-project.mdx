...
<VideoPlayer src="https://storage.googleapis.com/cdn.csquare.run/docs/webm/delete-a-project.webm" />
...
6. You can now see that your project is not displayed in the projects table anymore. Nicely done!
