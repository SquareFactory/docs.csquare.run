...
You can see who are the administrators of a project on the **Collaborators** page. Look for the _admin_ badges in the collaborators table.
...
1. [Select a project](../select-project).
