...
1. #### Select a project:
   1. If you do not have any project, or you want to work with a new project, create a new one by clicking on the `+` button. See [how to fill the form](../projects/create-a-project).
...
2. #### Manage your datasets: create a new one, import a dataset from another project, or update existing ones. The listed datasets are the ones you will be able to use to run your new experiment.
   - ##### Create a dataset:
     ...
     4. You can now see you dataset in the table.
...
3. #### Manage your models: see the project's models and create a new one. The listed models are the ones you will be able to use to run your new experiment.
   - ##### Create a model:
     1. Click on the `+` button.
     2. [Fill the form](.../models/create-a-model#fill-the-form) and submit it.
     3. You can now see your new model in the table.
4. #### Run an experiment by filling the form. [See how](/models/create-a-model#fill-the-form) (follow from step 4).
...
On the `models` page, click on the model you just created to access its dashboard. From there, click on the `+` button of the experiment widget, and fill the form to [create a new experiment](../experiments/run-an-experiment).
