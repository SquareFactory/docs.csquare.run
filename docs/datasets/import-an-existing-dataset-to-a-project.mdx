...
<VideoPlayer src="https://cdn.csquare.run/docs/webm/import-dataset.webm" />

## Step-by-step

1. [Select the project](../projects/select-project.mdx) you want to import the dataset into.
2. Open the sidebar and go to the `Datasets` page.
3. Click on the `Import` button.
4. Choose the dataset you want to import to your current project.
