...
To simplify the dataset uploads, you can simply use the web interface available at: [https://storage.csquare.run](https://storage.csquare.run).

![Datasets Web UI](https://storage.googleapis.com/cdn.csquare.run/docs/img/datasets-web-ui.png)

On the web interface, you can quickly upload, delete files via your web browser.
