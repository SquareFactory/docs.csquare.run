...
## Using the c-square's explorer

### Quick guide

<VideoPlayer src="https://storage.googleapis.com/cdn.csquare.run/docs/webm/upload-a-file.webm" />

### Step-by-step

1. [Select the project](../projects/select-a-project.mdx) you want to work with.
